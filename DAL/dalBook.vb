...
Public Class dalBook
    ...
    Public Shared Function AddBook(ByVal book As Model.Book) As Boolean
        ...
        Dim parm As SqlParameter() = New SqlParameter() {New SqlParameter("@bookName", SqlDbType.VarChar), New SqlParameter("@bookType", SqlDbType.Int), New SqlParameter("@price", SqlDbType.Float), New SqlParameter("@count", SqlDbType.Int), New SqlParameter("@publish", SqlDbType.VarChar), New SqlParameter("@barcode", SqlDbType.VarChar), _
    ...
    Public Shared Function EditBook(ByVal book As Model.Book) As Boolean
        ...
        Dim parm As SqlParameter() = New SqlParameter() {New SqlParameter("@bookName", SqlDbType.VarChar), New SqlParameter("@bookType", SqlDbType.Int), New SqlParameter("@price", SqlDbType.Float), New SqlParameter("@count", SqlDbType.Int), New SqlParameter("@publish", SqlDbType.VarChar), New SqlParameter("@bookPhoto", SqlDbType.Image), _
    ...
    Public Shared Function GetBook(ByVal PageIndex As Integer, ByVal PageSize As Integer, ByRef PageCount As Integer, ByRef RecordCount As Integer, ByVal strWhere As String) As System.Data.DataTable
        Try
            ...
            Return DAL.DBHelp.ExecutePagerWhenPrimaryIsString(PageIndex, PageSize, "barcode", strShow, strSql, strWhere, _
